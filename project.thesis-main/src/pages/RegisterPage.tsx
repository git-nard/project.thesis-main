          ...
          <form onSubmit={handleSubmit} className="space-y-5">
            ...
            <div>
              ...
              <input
                ...
                onChange={handleChange}
                required
                className="w-full px-4 py-2 border border-gray-700 bg-gray-800 rounded-lg text-white focus:outline-none focus:ring-2 focus:ring-pink-500 transition"
              />
            </div>

            <button
              type="submit"
              className="w-full py-2 bg-gradient-to-r from-pink-500 to-indigo-600 text-white font-semibold rounded-lg shadow-md hover:opacity-90 transition-all"
            >
              Sign Up
            </button>
          </form>
